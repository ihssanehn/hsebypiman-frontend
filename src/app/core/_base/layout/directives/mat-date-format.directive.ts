...
@Directive({
  selector: '[matDateFormat]',
  providers: [
    {provide: MAT_INPUT_VALUE_ACCESSOR, useExisting: MatDateFormatDirective}
  ]
})
export class MatDateFormatDirective implements ControlValueAccessor {
