...
import { RevueService, ChantierService} from '@app/core/services';
import { Revue, Chantier } from '@app/core/models';
...
@Component({
  selector: 'tf-visite-revue-edit',
  templateUrl: './visite-revue-edit.component.html',
  styleUrls: ['./visite-revue-edit.component.scss']
})
export class VisiteRevueEditComponent implements OnInit, OnDestroy {
