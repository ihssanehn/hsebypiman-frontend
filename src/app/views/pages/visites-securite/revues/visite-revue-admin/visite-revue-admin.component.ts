...
@Component({
  selector: 'tf-visite-revue-admin',
  templateUrl: './visite-revue-admin.component.html',
  styleUrls: ['./visite-revue-admin.component.scss']
})
export class VisiteRevueAdminComponent implements OnInit {
