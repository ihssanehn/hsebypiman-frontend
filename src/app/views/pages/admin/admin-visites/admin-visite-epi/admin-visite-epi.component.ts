...
@Component({
  selector: 'tf-admin-visite-epi',
  templateUrl: './admin-visite-epi.component.html',
  styleUrls: ['./admin-visite-epi.component.scss']
})
export class AdminVisiteEpiComponent implements OnInit {
