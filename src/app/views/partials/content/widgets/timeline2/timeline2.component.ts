	...
	ngOnInit() {
		if (!this.data) {
			this.data = [
				{
					time: '10:00',
					icon: 'fa fa-genderless tf-font-danger',
					text: 'Lorem ipsum dolor sit amit,consectetur eiusmdd tempor\n' +
						'incididunt ut labore et dolore magna',
				},
				{
					time: '12:45',
					icon: 'fa fa-genderless tf-font-success',
				...
				{
					time: '14:00',
					icon: 'fa fa-genderless tf-font-brand',
					text: 'Make Deposit <a href="$event.preventDefault();" class="tf-link tf-link--brand tf-font-bolder">USD 700</a> To ESL.',
				},
				{
					time: '17:00',
					icon: 'fa fa-genderless tf-font-info',
					text: 'Placed a new order in <a href="$event.preventDefault();" class="tf-link tf-link--brand tf-font-bolder">SIGNATURE MOBILE</a> marketplace.',
				},
				{
					time: '16:00',
					icon: 'fa fa-genderless tf-font-brand',
				...
				},
				{
					time: '17:00',
					icon: 'fa fa-genderless tf-font-danger',
					text: 'Received a new feedback on <a href="$event.preventDefault();" class="tf-link tf-link--brand tf-font-bolder">FinancePro App</a> product.',
				},
			];
		}
	}
