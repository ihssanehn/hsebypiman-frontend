...
@Component({
  selector: 'tf-habilitations-admin-list-portlet',
  templateUrl: './habilitations-admin-list-portlet.component.html',
  styleUrls: ['./habilitations-admin-list-portlet.component.scss']
})
export class HabilitationsAdminListPortletComponent implements OnInit {
