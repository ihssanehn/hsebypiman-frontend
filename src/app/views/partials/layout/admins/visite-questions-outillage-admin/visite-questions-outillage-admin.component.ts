...
export class VisiteQuestionsOutillageAdminComponent extends AdminTemplateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //   deletedMessage: this.translate.instant("VISITES.NOTIF.ELEMENT_NOT_DELETED.OUTILLAGE.TITLE"),
    //   deletedChildMessage: this.translate.instant("VISITES.NOTIF.ELEMENT_NOT_DELETED.OUTILLAGE.LABEL"),
    //   collapsed : true,
    //   canUpdateTitle: true,
    //   titleObject: null,
    //   childCol : 6
