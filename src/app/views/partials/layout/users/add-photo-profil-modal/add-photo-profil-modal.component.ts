...
@Component({
  selector: 'tf-add-photo-profil-modal',
  templateUrl: './add-photo-profil-modal.component.html',
  styleUrls: ['./add-photo-profil-modal.component.scss']
})
export class AddPhotoProfilModalComponent implements OnInit{
