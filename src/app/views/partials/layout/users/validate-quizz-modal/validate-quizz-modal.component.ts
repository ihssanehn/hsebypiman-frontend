...
@Component({
  selector: 'tf-validate-quizz-modal',
  templateUrl: './validate-quizz-modal.component.html',
  styleUrls: ['./validate-quizz-modal.component.scss']
})
export class ValidateQuizzModalComponent implements OnInit {
